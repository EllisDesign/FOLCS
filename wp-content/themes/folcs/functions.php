...
function folcs_scripts() {
    ...
    wp_enqueue_style( 'folcs-style', get_template_directory_uri() . '/style.1.0.css', array(), '1.0.0', 'all');

    wp_enqueue_style( 'googlefonts-style', 'https://fonts.googleapis.com/css?family=Barlow:300,300i,400,500,600,700', array(), null, 'all');

    wp_enqueue_style( 'adobetypekit-style', 'https://use.typekit.net/rrw4mvd.css', array(), null, 'all');
